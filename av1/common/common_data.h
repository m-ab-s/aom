...
static const PARTITION_TYPE_REC
    symbol_map_from_partition_block_wgth[EXT_PARTITION_TYPES] = {
      PARTITION_NONE_REC,    PARTITION_SHORT_SIDE_REC, PARTITION_LONG_SIDE_REC,
...
static const PARTITION_TYPE_REC
    symbol_map_from_partition_block_hgtw[EXT_PARTITION_TYPES] = {
      PARTITION_NONE_REC,       PARTITION_LONG_SIDE_REC,
      PARTITION_SHORT_SIDE_REC, PARTITION_MULTI_WAY_REC,
      PARTITION_INVALID_REC,
    };

/* clang-format off */
// This table covers all square blocks and 1:2/2:1 rectangular blocks
static const BLOCK_SIZE subsize_lookup[EXT_PARTITION_TYPES + 1][BLOCK_SIZES] = {
  {     // PARTITION_NONE
