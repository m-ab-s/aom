...
static const aom_cdf_prob av1_default_eob_multi16_cdfs
    [TOKEN_CDF_Q_CTXS][EOB_CONTEXTS][PLANE_TYPES][2][CDF_SIZE(5)] = {
      {
          {
              {
                  { AOM_CDF5(11951, 13504, 18394, 23827) },
                  { AOM_CDF5(426, 1697, 8774, 13809) },
              },
              {
                  { AOM_CDF5(13710, 17715, 24658, 29248) },
                  { AOM_CDF5(3625, 6795, 15994, 24143) },
              },
          },
          {
              {
                  { AOM_CDF5(7761, 9867, 18151, 25069) },
                  { AOM_CDF5(952, 2830, 11807, 17995) },
              },
              {
                  { AOM_CDF5(7899, 11202, 21899, 27692) },
                  { AOM_CDF5(3291, 5998, 14731, 23664) },
              },
          },
          {
              {
                  { AOM_CDF5(5714, 7437, 14895, 23729) },
                  { AOM_CDF5(1140, 2811, 10489, 17508) },
              },
              {
                  { AOM_CDF5(5464, 8867, 17573, 26071) },
                  { AOM_CDF5(3194, 5588, 12426, 22186) },
              },
          },
          {
              {
                  { AOM_CDF5(4390, 5987, 12503, 22086) },
                  { AOM_CDF5(939, 1985, 8712, 16345) },
              },
              {
                  { AOM_CDF5(3937, 6740, 13628, 23803) },
                  { AOM_CDF5(2126, 3976, 9812, 19689) },
              },
          },
          {
              {
                  { AOM_CDF5(3501, 4732, 10198, 20205) },
                  { AOM_CDF5(847, 2009, 7719, 15060) },
              },
              {
                  { AOM_CDF5(3289, 5450, 12120, 21204) },
                  { AOM_CDF5(1801, 3543, 8715, 18820) },
              },
          },
          {
              {
                  { AOM_CDF5(2191, 3019, 8050, 17407) },
                  { AOM_CDF5(659, 1861, 6923, 13531) },
              },
              {
                  { AOM_CDF5(2548, 4096, 10005, 18085) },
                  { AOM_CDF5(1569, 3032, 7514, 17200) },
              },
          },
          {
              {
                  { AOM_CDF5(2032, 2675, 6322, 14829) },
                  { AOM_CDF5(700, 1481, 5422, 11640) },
              },
              {
                  { AOM_CDF5(2046, 3407, 7767, 15962) },
                  { AOM_CDF5(1418, 2602, 6333, 15332) },
              },
          },
          {
              {
                  { AOM_CDF5(208, 252, 590, 2215) },
                  { AOM_CDF5(147, 247, 999, 2949) },
              },
              {
                  { AOM_CDF5(620, 981, 2440, 6351) },
                  { AOM_CDF5(570, 1006, 2834, 8414) },
              },
          },
      },
      {
          {
              {
                  { AOM_CDF5(14999, 15885, 20934, 26269) },
                  { AOM_CDF5(180, 722, 4755, 9901) },
              },
              {
                  { AOM_CDF5(17593, 20772, 26074, 30255) },
                  { AOM_CDF5(4933, 7820, 17102, 25559) },
              },
          },
          {
              {
                  { AOM_CDF5(11912, 13252, 21654, 27503) },
                  { AOM_CDF5(684, 2135, 9295, 15659) },
              },
              {
                  { AOM_CDF5(11097, 14073, 23788, 29028) },
                  { AOM_CDF5(5142, 7958, 17076, 26221) },
              },
          },
          {
              {
                  { AOM_CDF5(8500, 9771, 18842, 26304) },
                  { AOM_CDF5(645, 1634, 8004, 15188) },
              },
              {
                  { AOM_CDF5(7366, 10785, 19032, 27543) },
                  { AOM_CDF5(4238, 6620, 13721, 24350) },
              },
          },
          {
              {
                  { AOM_CDF5(6025, 7069, 15749, 25077) },
                  { AOM_CDF5(556, 1405, 6717, 14688) },
              },
              {
                  { AOM_CDF5(5282, 8165, 14831, 25351) },
                  { AOM_CDF5(3138, 4938, 11096, 22264) },
              },
          },
          {
              {
                  { AOM_CDF5(4794, 5728, 12969, 22619) },
                  { AOM_CDF5(552, 1265, 5691, 13494) },
              },
              {
                  { AOM_CDF5(4701, 6818, 13744, 22880) },
                  { AOM_CDF5(2753, 4273, 9449, 20889) },
              },
          },
          {
              {
                  { AOM_CDF5(3491, 4123, 10775, 19856) },
                  { AOM_CDF5(449, 893, 4292, 11302) },
              },
              {
                  { AOM_CDF5(3535, 5113, 11174, 19857) },
                  { AOM_CDF5(2020, 3139, 7435, 18533) },
              },
          },
          {
              {
                  { AOM_CDF5(3100, 3620, 8915, 17665) },
                  { AOM_CDF5(473, 846, 3572, 10483) },
              },
              {
                  { AOM_CDF5(2753, 4071, 8699, 17538) },
                  { AOM_CDF5(1758, 2664, 6128, 16541) },
              },
          },
          {
              {
                  { AOM_CDF5(647, 734, 1766, 4720) },
                  { AOM_CDF5(282, 358, 944, 3438) },
              },
              {
                  { AOM_CDF5(1121, 1641, 3732, 9074) },
                  { AOM_CDF5(783, 1160, 2723, 9084) },
              },
          },
      },
      {
          {
              {
                  { AOM_CDF5(13833, 14756, 19670, 25910) },
                  { AOM_CDF5(159, 260, 2318, 9021) },
              },
              {
                  { AOM_CDF5(19481, 22756, 27381, 31197) },
                  { AOM_CDF5(6303, 9586, 18886, 27166) },
              },
          },
          {
              {
                  { AOM_CDF5(11686, 13066, 21077, 26842) },
                  { AOM_CDF5(472, 904, 3776, 10481) },
              },
              {
                  { AOM_CDF5(12807, 15943, 24572, 29877) },
                  { AOM_CDF5(6165, 9237, 17997, 27329) },
              },
          },
          {
              {
                  { AOM_CDF5(8951, 10393, 18331, 25462) },
                  { AOM_CDF5(547, 908, 3254, 11994) },
              },
              {
                  { AOM_CDF5(9052, 12809, 19972, 28617) },
                  { AOM_CDF5(5370, 8089, 14872, 25452) },
              },
          },
          {
              {
                  { AOM_CDF5(6621, 7935, 15095, 24029) },
                  { AOM_CDF5(659, 1105, 3529, 13017) },
              },
              {
                  { AOM_CDF5(6665, 9786, 15921, 26615) },
                  { AOM_CDF5(3949, 5987, 12102, 23414) },
              },
          },
          {
              {
                  { AOM_CDF5(6116, 7166, 13724, 21853) },
                  { AOM_CDF5(515, 836, 3127, 11864) },
              },
              {
                  { AOM_CDF5(6127, 8408, 14918, 24224) },
                  { AOM_CDF5(3531, 5257, 10615, 21398) },
              },
          },
          {
              {
                  { AOM_CDF5(4981, 5702, 11786, 19375) },
                  { AOM_CDF5(482, 803, 2257, 10004) },
              },
              {
                  { AOM_CDF5(4783, 6572, 12429, 21513) },
                  { AOM_CDF5(2712, 4114, 8418, 18821) },
              },
          },
          {
              {
                  { AOM_CDF5(4560, 5110, 10303, 17735) },
                  { AOM_CDF5(458, 724, 2369, 9242) },
              },
              {
                  { AOM_CDF5(3835, 5384, 10045, 19386) },
                  { AOM_CDF5(2381, 3511, 7002, 16955) },
              },
          },
          {
              {
                  { AOM_CDF5(1337, 1518, 3166, 6668) },
                  { AOM_CDF5(408, 479, 1103, 4904) },
              },
              {
                  { AOM_CDF5(1806, 2571, 5051, 11707) },
                  { AOM_CDF5(1271, 1845, 3646, 10142) },
              },
          },
      },
      {
          {
              {
                  { AOM_CDF5(10294, 12856, 19764, 27243) },
                  { AOM_CDF5(492, 837, 4819, 15952) },
              },
              {
                  { AOM_CDF5(23503, 26285, 29798, 32153) },
                  { AOM_CDF5(9115, 12846, 22326, 29277) },
              },
          },
          {
              {
                  { AOM_CDF5(10313, 12211, 20646, 27268) },
                  { AOM_CDF5(1149, 1923, 6307, 17364) },
              },
              {
                  { AOM_CDF5(15321, 18579, 26328, 30969) },
                  { AOM_CDF5(7868, 11102, 19678, 28266) },
              },
          },
          {
              {
                  { AOM_CDF5(8768, 11038, 18456, 26084) },
                  { AOM_CDF5(955, 1671, 5214, 16850) },
              },
              {
                  { AOM_CDF5(11665, 15597, 22176, 29941) },
                  { AOM_CDF5(6901, 9869, 16070, 26482) },
              },
          },
          {
              {
                  { AOM_CDF5(7032, 8940, 15810, 24706) },
                  { AOM_CDF5(961, 1551, 4839, 16374) },
              },
              {
                  { AOM_CDF5(8877, 12298, 18276, 28235) },
                  { AOM_CDF5(5186, 7676, 13421, 23884) },
              },
          },
          {
              {
                  { AOM_CDF5(6914, 8285, 14828, 22651) },
                  { AOM_CDF5(1036, 1740, 4368, 14854) },
              },
              {
                  { AOM_CDF5(8085, 10700, 17088, 26118) },
                  { AOM_CDF5(4608, 6528, 11673, 22074) },
              },
          },
          {
              {
                  { AOM_CDF5(5859, 6989, 13045, 20247) },
                  { AOM_CDF5(862, 1259, 3565, 12946) },
              },
              {
                  { AOM_CDF5(6286, 8486, 14137, 23298) },
                  { AOM_CDF5(3754, 5183, 9436, 19226) },
              },
          },
          {
              {
                  { AOM_CDF5(4905, 6015, 11269, 18388) },
                  { AOM_CDF5(729, 1239, 2955, 11880) },
              },
              {
                  { AOM_CDF5(5015, 7127, 11866, 21751) },
                  { AOM_CDF5(2635, 4252, 7812, 17629) },
              },
          },
          {
              {
                  { AOM_CDF5(2158, 2478, 5072, 9875) },
                  { AOM_CDF5(628, 822, 1639, 8020) },
              },
              {
                  { AOM_CDF5(2783, 3958, 6903, 14960) },
                  { AOM_CDF5(1555, 2140, 4134, 11427) },
              },
          },
      },
    };
...
static const aom_cdf_prob av1_default_eob_multi32_cdfs
    [TOKEN_CDF_Q_CTXS][EOB_CONTEXTS][PLANE_TYPES][2][CDF_SIZE(6)] = {
      {
          {
              {
                  { AOM_CDF6(5786, 7085, 13029, 19061, 26008) },
                  { AOM_CDF6(337, 947, 3878, 10257, 17902) },
              },
              {
                  { AOM_CDF6(12783, 17712, 24863, 29411, 31746) },
                  { AOM_CDF6(3382, 6261, 14822, 22040, 28239) },
              },
          },
          {
              {
                  { AOM_CDF6(2936, 3953, 8926, 16882, 26225) },
                  { AOM_CDF6(568, 1307, 4886, 12857, 21259) },
              },
              {
                  { AOM_CDF6(5276, 9066, 16506, 24956, 30711) },
                  { AOM_CDF6(2461, 4611, 10816, 18885, 27759) },
              },
          },
          {
              {
                  { AOM_CDF6(1901, 2704, 6069, 13339, 24468) },
                  { AOM_CDF6(429, 990, 3895, 11323, 19716) },
              },
              {
                  { AOM_CDF6(3362, 6011, 11294, 19524, 28519) },
                  { AOM_CDF6(1698, 3497, 7853, 14502, 24534) },
              },
          },
          {
              {
                  { AOM_CDF6(1197, 1550, 3651, 9414, 21219) },
                  { AOM_CDF6(297, 663, 2915, 8677, 17448) },
              },
              {
                  { AOM_CDF6(2470, 4284, 8248, 15030, 26400) },
                  { AOM_CDF6(1390, 2526, 5540, 10566, 22221) },
              },
          },
          {
              {
                  { AOM_CDF6(823, 1106, 2443, 6558, 18294) },
                  { AOM_CDF6(233, 559, 1958, 6634, 14535) },
              },
              {
                  { AOM_CDF6(1951, 3286, 6247, 11436, 23554) },
                  { AOM_CDF6(1116, 2150, 5027, 9314, 21123) },
              },
          },
          {
              {
                  { AOM_CDF6(511, 705, 1583, 4510, 16052) },
                  { AOM_CDF6(224, 459, 1793, 6036, 14059) },
              },
              {
                  { AOM_CDF6(1171, 2151, 4461, 8847, 21117) },
                  { AOM_CDF6(861, 1614, 3931, 7654, 19280) },
              },
          },
          {
              {
                  { AOM_CDF6(328, 446, 1082, 2958, 12101) },
                  { AOM_CDF6(225, 422, 1335, 4706, 11802) },
              },
              {
                  { AOM_CDF6(1008, 1798, 3574, 6901, 17715) },
                  { AOM_CDF6(604, 1528, 3354, 6632, 17830) },
              },
          },
          {
              {
                  { AOM_CDF6(94, 115, 212, 498, 2385) },
                  { AOM_CDF6(53, 102, 280, 1122, 3358) },
              },
              {
                  { AOM_CDF6(479, 814, 1611, 3023, 8513) },
                  { AOM_CDF6(302, 637, 1703, 3736, 9552) },
              },
          },
      },
      {
          {
              {
                  { AOM_CDF6(6951, 7819, 11299, 18025, 25520) },
                  { AOM_CDF6(141, 339, 1591, 5100, 14756) },
              },
              {
                  { AOM_CDF6(17393, 20828, 25833, 29810, 31770) },
                  { AOM_CDF6(6093, 8902, 17832, 24489, 29814) },
              },
          },
          {
              {
                  { AOM_CDF6(3797, 4598, 8176, 16680, 26473) },
                  { AOM_CDF6(341, 658, 2489, 7056, 17411) },
              },
              {
                  { AOM_CDF6(7338, 10677, 17254, 25763, 31486) },
                  { AOM_CDF6(4085, 6053, 12629, 21455, 29824) },
              },
          },
          {
              {
                  { AOM_CDF6(2358, 2875, 5252, 12974, 24729) },
                  { AOM_CDF6(313, 490, 1671, 5584, 15968) },
              },
              {
                  { AOM_CDF6(4128, 6171, 10897, 19800, 29978) },
                  { AOM_CDF6(2443, 3549, 7367, 15081, 27369) },
              },
          },
          {
              {
                  { AOM_CDF6(1715, 2028, 3542, 9548, 21958) },
                  { AOM_CDF6(314, 502, 1445, 4075, 13149) },
              },
              {
                  { AOM_CDF6(2580, 3687, 6715, 13715, 28225) },
                  { AOM_CDF6(1287, 1884, 3819, 9517, 25906) },
              },
          },
          {
              {
                  { AOM_CDF6(1212, 1449, 2592, 6988, 19704) },
                  { AOM_CDF6(289, 397, 1057, 3213, 11142) },
              },
              {
                  { AOM_CDF6(1679, 2348, 4259, 9566, 25594) },
                  { AOM_CDF6(888, 1277, 2661, 6607, 23195) },
              },
          },
          {
              {
                  { AOM_CDF6(826, 979, 1757, 5286, 17831) },
                  { AOM_CDF6(241, 392, 941, 3212, 12148) },
              },
              {
                  { AOM_CDF6(1334, 1874, 3365, 7445, 23460) },
                  { AOM_CDF6(673, 1033, 2016, 5157, 20897) },
              },
          },
          {
              {
                  { AOM_CDF6(615, 738, 1263, 3493, 13830) },
                  { AOM_CDF6(235, 335, 761, 2686, 10521) },
              },
              {
                  { AOM_CDF6(1130, 1507, 2564, 5399, 18337) },
                  { AOM_CDF6(575, 823, 1611, 3821, 16342) },
              },
          },
          {
              {
                  { AOM_CDF6(276, 314, 456, 1023, 3782) },
                  { AOM_CDF6(119, 145, 235, 578, 2477) },
              },
              {
                  { AOM_CDF6(593, 791, 1296, 2554, 8347) },
                  { AOM_CDF6(317, 436, 811, 1827, 7535) },
              },
          },
      },
      {
          {
              {
                  { AOM_CDF6(7355, 8168, 11856, 18776, 26685) },
                  { AOM_CDF6(271, 436, 1360, 4572, 16138) },
              },
              {
                  { AOM_CDF6(21047, 24094, 28229, 31184, 32353) },
                  { AOM_CDF6(6620, 9706, 19438, 25950, 30785) },
              },
          },
          {
              {
                  { AOM_CDF6(4896, 5678, 9005, 16890, 26886) },
                  { AOM_CDF6(598, 908, 2282, 6047, 17952) },
              },
              {
                  { AOM_CDF6(9781, 13182, 19591, 27538, 32012) },
                  { AOM_CDF6(4640, 6803, 13443, 22580, 30476) },
              },
          },
          {
              {
                  { AOM_CDF6(3513, 4112, 6408, 13217, 24488) },
                  { AOM_CDF6(532, 748, 1688, 5013, 16166) },
              },
              {
                  { AOM_CDF6(6296, 8544, 13270, 22205, 30786) },
                  { AOM_CDF6(2725, 4002, 7957, 17070, 28729) },
              },
          },
          {
              {
                  { AOM_CDF6(2733, 3258, 4968, 10530, 21671) },
                  { AOM_CDF6(402, 569, 1269, 3653, 13037) },
              },
              {
                  { AOM_CDF6(4382, 5883, 9045, 16807, 29049) },
                  { AOM_CDF6(1718, 2512, 4859, 12794, 27148) },
              },
          },
          {
              {
                  { AOM_CDF6(2325, 2647, 4171, 8817, 19641) },
                  { AOM_CDF6(458, 632, 1164, 3263, 11177) },
              },
              {
                  { AOM_CDF6(3478, 4590, 7323, 13531, 26352) },
                  { AOM_CDF6(1538, 2214, 4343, 9658, 23803) },
              },
          },
          {
              {
                  { AOM_CDF6(1712, 1981, 3160, 7072, 17820) },
                  { AOM_CDF6(416, 552, 1115, 3387, 12259) },
              },
              {
                  { AOM_CDF6(2945, 3797, 5936, 11118, 23901) },
                  { AOM_CDF6(1277, 1951, 3557, 7764, 21156) },
              },
          },
          {
              {
                  { AOM_CDF6(1346, 1573, 2415, 5379, 14299) },
                  { AOM_CDF6(394, 495, 911, 2677, 10298) },
              },
              {
                  { AOM_CDF6(2555, 3268, 4876, 8440, 19460) },
                  { AOM_CDF6(1091, 1877, 3542, 7213, 18009) },
              },
          },
          {
              {
                  { AOM_CDF6(587, 645, 879, 1796, 4947) },
                  { AOM_CDF6(185, 214, 318, 794, 3660) },
              },
              {
                  { AOM_CDF6(1401, 1850, 2742, 4861, 11361) },
                  { AOM_CDF6(777, 1165, 2416, 4627, 12213) },
              },
          },
      },
      {
          {
              {
                  { AOM_CDF6(7121, 8830, 13838, 21102, 29187) },
                  { AOM_CDF6(903, 1413, 2952, 9622, 23290) },
              },
              {
                  { AOM_CDF6(25464, 27798, 30585, 32232, 32691) },
                  { AOM_CDF6(9817, 13337, 24105, 29164, 32018) },
              },
          },
          {
              {
                  { AOM_CDF6(5836, 7007, 10689, 18101, 28370) },
                  { AOM_CDF6(1339, 1962, 3780, 10111, 23391) },
              },
              {
                  { AOM_CDF6(13154, 16620, 22441, 29173, 32386) },
                  { AOM_CDF6(6786, 9230, 16733, 25431, 31329) },
              },
          },
          {
              {
                  { AOM_CDF6(4550, 5373, 8152, 14411, 25841) },
                  { AOM_CDF6(1023, 1411, 2727, 7351, 21109) },
              },
              {
                  { AOM_CDF6(9274, 11813, 16690, 25030, 31556) },
                  { AOM_CDF6(4791, 6994, 11720, 19465, 29340) },
              },
          },
          {
              {
                  { AOM_CDF6(3779, 4401, 6562, 11892, 23065) },
                  { AOM_CDF6(828, 1158, 1924, 5767, 18120) },
              },
              {
                  { AOM_CDF6(7058, 8746, 12335, 20010, 30240) },
                  { AOM_CDF6(4069, 5403, 10459, 16960, 27378) },
              },
          },
          {
              {
                  { AOM_CDF6(3116, 3753, 5479, 9706, 20659) },
                  { AOM_CDF6(669, 929, 1720, 5156, 16194) },
              },
              {
                  { AOM_CDF6(5774, 7152, 10200, 16296, 28110) },
                  { AOM_CDF6(3419, 4765, 8104, 14189, 23936) },
              },
          },
          {
              {
                  { AOM_CDF6(2522, 2869, 4111, 7708, 17950) },
                  { AOM_CDF6(667, 902, 1544, 4659, 15450) },
              },
              {
                  { AOM_CDF6(4683, 5944, 8589, 13096, 25985) },
                  { AOM_CDF6(2209, 3431, 7004, 13022, 22425) },
              },
          },
          {
              {
                  { AOM_CDF6(1825, 2127, 3138, 5866, 14490) },
                  { AOM_CDF6(394, 572, 1094, 3284, 12830) },
              },
              {
                  { AOM_CDF6(4191, 5458, 7561, 10874, 22426) },
                  { AOM_CDF6(3149, 3659, 6553, 11319, 21873) },
              },
          },
          {
              {
                  { AOM_CDF6(745, 849, 1161, 2101, 5843) },
                  { AOM_CDF6(262, 316, 457, 1119, 5796) },
              },
              {
                  { AOM_CDF6(2489, 3324, 4902, 7685, 15664) },
                  { AOM_CDF6(2274, 3750, 7192, 10758, 17767) },
              },
          },
      },
    };
...
static const aom_cdf_prob av1_default_eob_multi64_cdfs
    [TOKEN_CDF_Q_CTXS][EOB_CONTEXTS][PLANE_TYPES][2][CDF_SIZE(7)] = {
      {
          {
              {
                  { AOM_CDF7(4725, 6676, 14333, 19288, 26083, 30318) },
                  { AOM_CDF7(389, 1281, 3020, 14618, 21050, 26700) },
              },
              {
                  { AOM_CDF7(9506, 13271, 22210, 26987, 30287, 31921) },
                  { AOM_CDF7(3022, 4954, 8682, 19150, 23612, 29252) },
              },
          },
          {
              {
                  { AOM_CDF7(1672, 2214, 5840, 10848, 20472, 28904) },
                  { AOM_CDF7(250, 737, 1933, 10784, 19739, 26788) },
              },
              {
                  { AOM_CDF7(3242, 5138, 10132, 15512, 23328, 29695) },
                  { AOM_CDF7(1504, 2749, 4893, 11118, 16340, 26162) },
              },
          },
          {
              {
                  { AOM_CDF7(736, 1049, 2525, 4997, 12519, 25097) },
                  { AOM_CDF7(193, 517, 1313, 6598, 13456, 22258) },
              },
              {
                  { AOM_CDF7(2055, 3384, 6220, 9166, 14524, 23782) },
                  { AOM_CDF7(806, 1669, 2982, 6546, 10522, 22076) },
              },
          },
          {
              {
                  { AOM_CDF7(412, 579, 1300, 2517, 6572, 19048) },
                  { AOM_CDF7(170, 569, 1021, 4120, 8720, 16830) },
              },
              {
                  { AOM_CDF7(1337, 2259, 3689, 5551, 8835, 17763) },
                  { AOM_CDF7(403, 1083, 1805, 3716, 6179, 19219) },
              },
          },
          {
              {
                  { AOM_CDF7(217, 334, 678, 1277, 3199, 11745) },
                  { AOM_CDF7(112, 314, 615, 2730, 5549, 11871) },
              },
              {
                  { AOM_CDF7(1038, 1355, 2387, 3680, 5345, 11894) },
                  { AOM_CDF7(463, 518, 682, 2155, 3737, 15306) },
              },
          },
          {
              {
                  { AOM_CDF7(120, 164, 323, 595, 1441, 5808) },
                  { AOM_CDF7(46, 141, 283, 1363, 3230, 7833) },
              },
              {
                  { AOM_CDF7(292, 386, 854, 1602, 2702, 6726) },
                  { AOM_CDF7(310, 487, 1019, 2261, 3325, 11218) },
              },
          },
          {
              {
                  { AOM_CDF7(69, 87, 161, 312, 641, 2326) },
                  { AOM_CDF7(25, 97, 174, 594, 1417, 3652) },
              },
              {
                  { AOM_CDF7(126, 235, 598, 961, 1904, 4479) },
                  { AOM_CDF7(231, 385, 539, 1310, 1773, 5011) },
              },
          },
          {
              {
                  { AOM_CDF7(36, 43, 70, 118, 241, 644) },
                  { AOM_CDF7(15, 31, 57, 198, 457, 1150) },
              },
              {
                  { AOM_CDF7(201, 245, 379, 647, 1139, 2077) },
                  { AOM_CDF7(85, 85, 85, 85, 766, 1617) },
              },
          },
      },
      {
          {
              {
                  { AOM_CDF7(6209, 6949, 11094, 16814, 22597, 27465) },
                  { AOM_CDF7(180, 372, 908, 5360, 11721, 22768) },
              },
              {
                  { AOM_CDF7(13630, 16425, 22214, 26293, 29633, 31504) },
                  { AOM_CDF7(4922, 6536, 10667, 19752, 25256, 29825) },
              },
          },
          {
              {
                  { AOM_CDF7(2435, 2725, 5176, 10312, 19487, 28233) },
                  { AOM_CDF7(313, 645, 979, 3973, 11476, 24318) },
              },
              {
                  { AOM_CDF7(3113, 4434, 7856, 12729, 21667, 29623) },
                  { AOM_CDF7(2106, 2770, 4355, 9415, 17044, 27868) },
              },
          },
          {
              {
                  { AOM_CDF7(1080, 1193, 1971, 4634, 11612, 24182) },
                  { AOM_CDF7(264, 394, 546, 1853, 6848, 20908) },
              },
              {
                  { AOM_CDF7(1308, 1768, 2904, 4816, 10422, 22859) },
                  { AOM_CDF7(610, 858, 1384, 3284, 7040, 25142) },
              },
          },
          {
              {
                  { AOM_CDF7(578, 634, 968, 2038, 5899, 18037) },
                  { AOM_CDF7(170, 238, 331, 1002, 3658, 15813) },
              },
              {
                  { AOM_CDF7(720, 983, 1591, 2453, 4742, 15901) },
                  { AOM_CDF7(325, 479, 765, 1600, 3533, 21649) },
              },
          },
          {
              {
                  { AOM_CDF7(317, 352, 526, 961, 2638, 11442) },
                  { AOM_CDF7(110, 157, 213, 620, 1965, 10607) },
              },
              {
                  { AOM_CDF7(520, 693, 1073, 1538, 2561, 9057) },
                  { AOM_CDF7(271, 358, 570, 1242, 2344, 14809) },
              },
          },
          {
              {
                  { AOM_CDF7(160, 183, 258, 484, 1230, 6106) },
                  { AOM_CDF7(69, 94, 127, 330, 927, 6428) },
              },
              {
                  { AOM_CDF7(312, 418, 706, 1079, 1807, 5311) },
                  { AOM_CDF7(119, 230, 392, 837, 1763, 8322) },
              },
          },
          {
              {
                  { AOM_CDF7(118, 134, 187, 302, 679, 2245) },
                  { AOM_CDF7(43, 61, 86, 213, 495, 2569) },
              },
              {
                  { AOM_CDF7(291, 387, 584, 828, 1239, 3476) },
                  { AOM_CDF7(160, 227, 376, 750, 1469, 5020) },
              },
          },
          {
              {
                  { AOM_CDF7(54, 62, 84, 126, 230, 468) },
                  { AOM_CDF7(23, 34, 48, 91, 207, 534) },
              },
              {
                  { AOM_CDF7(221, 276, 441, 579, 869, 1670) },
                  { AOM_CDF7(168, 306, 482, 654, 957, 2205) },
              },
          },
      },
      {
          {
              {
                  { AOM_CDF7(6851, 7526, 11048, 18216, 24156, 28788) },
                  { AOM_CDF7(230, 453, 903, 3935, 10926, 24026) },
              },
              {
                  { AOM_CDF7(19830, 22239, 26509, 29561, 31452, 32243) },
                  { AOM_CDF7(6572, 9189, 13936, 22414, 27461, 31117) },
              },
          },
          {
              {
                  { AOM_CDF7(2813, 3151, 5539, 11784, 20774, 29065) },
                  { AOM_CDF7(405, 668, 975, 3180, 10729, 25043) },
              },
              {
                  { AOM_CDF7(6066, 7718, 11590, 16628, 23770, 30930) },
                  { AOM_CDF7(2618, 3776, 5965, 10590, 19614, 29504) },
              },
          },
          {
              {
                  { AOM_CDF7(1406, 1531, 2566, 6054, 13218, 25191) },
                  { AOM_CDF7(279, 436, 628, 1703, 6773, 21688) },
              },
              {
                  { AOM_CDF7(2534, 3219, 4528, 6504, 10603, 26730) },
                  { AOM_CDF7(1113, 1564, 2392, 4658, 11682, 27018) },
              },
          },
          {
              {
                  { AOM_CDF7(878, 955, 1531, 3242, 7511, 18966) },
                  { AOM_CDF7(202, 301, 400, 1032, 4129, 16677) },
              },
              {
                  { AOM_CDF7(1902, 2452, 3472, 4860, 7960, 21373) },
                  { AOM_CDF7(887, 1342, 2121, 3976, 8914, 21976) },
              },
          },
          {
              {
                  { AOM_CDF7(538, 603, 932, 1830, 4036, 11895) },
                  { AOM_CDF7(138, 198, 265, 629, 2401, 11807) },
              },
              {
                  { AOM_CDF7(1634, 2066, 2981, 4231, 6182, 14043) },
                  { AOM_CDF7(812, 1267, 1971, 3865, 6762, 15641) },
              },
          },
          {
              {
                  { AOM_CDF7(300, 341, 518, 995, 2165, 6701) },
                  { AOM_CDF7(92, 139, 181, 361, 1267, 7599) },
              },
              {
                  { AOM_CDF7(1046, 1364, 1875, 2659, 3976, 8962) },
                  { AOM_CDF7(875, 1196, 1985, 3416, 5981, 12345) },
              },
          },
          {
              {
                  { AOM_CDF7(180, 208, 300, 530, 1101, 2702) },
                  { AOM_CDF7(60, 83, 112, 208, 610, 3234) },
              },
              {
                  { AOM_CDF7(1169, 1345, 1715, 2718, 4055, 7292) },
                  { AOM_CDF7(580, 882, 1286, 2345, 4616, 9106) },
              },
          },
          {
              {
                  { AOM_CDF7(81, 97, 138, 221, 386, 785) },
                  { AOM_CDF7(31, 44, 61, 109, 280, 906) },
              },
              {
                  { AOM_CDF7(1206, 1504, 2453, 3484, 4433, 7036) },
                  { AOM_CDF7(815, 1159, 1589, 2705, 4938, 9233) },
              },
          },
      },
      {
          {
              {
                  { AOM_CDF7(6874, 9237, 14586, 22337, 28174, 31247) },
                  { AOM_CDF7(654, 1510, 2834, 7470, 16437, 28150) },
              },
              {
                  { AOM_CDF7(25629, 27462, 29919, 31642, 32371, 32649) },
                  { AOM_CDF7(9905, 13059, 18522, 26946, 30084, 32161) },
              },
          },
          {
              {
                  { AOM_CDF7(3537, 4336, 8189, 14562, 23878, 30464) },
                  { AOM_CDF7(720, 1433, 2234, 5112, 13864, 27114) },
              },
              {
                  { AOM_CDF7(10557, 12657, 16641, 21475, 27289, 31726) },
                  { AOM_CDF7(4904, 6931, 9586, 15947, 23239, 30391) },
              },
          },
          {
              {
                  { AOM_CDF7(2237, 2604, 4652, 8198, 15852, 26480) },
                  { AOM_CDF7(395, 850, 1226, 2895, 9185, 23196) },
              },
              {
                  { AOM_CDF7(6472, 7738, 9885, 12717, 17909, 27528) },
                  { AOM_CDF7(2875, 4011, 5928, 11041, 16721, 26235) },
              },
          },
          {
              {
                  { AOM_CDF7(1641, 1821, 3086, 5208, 9839, 20164) },
                  { AOM_CDF7(295, 534, 779, 1798, 5857, 18398) },
              },
              {
                  { AOM_CDF7(4797, 5797, 7547, 10078, 14016, 22079) },
                  { AOM_CDF7(1026, 2707, 4574, 7561, 12603, 23058) },
              },
          },
          {
              {
                  { AOM_CDF7(987, 1115, 1727, 2851, 5530, 13179) },
                  { AOM_CDF7(207, 336, 529, 1117, 3561, 13367) },
              },
              {
                  { AOM_CDF7(5480, 6084, 6916, 8579, 10695, 16213) },
                  { AOM_CDF7(3171, 4439, 6976, 11627, 13318, 22197) },
              },
          },
          {
              {
                  { AOM_CDF7(533, 622, 957, 1581, 2912, 7507) },
                  { AOM_CDF7(142, 224, 326, 686, 2107, 8992) },
              },
              {
                  { AOM_CDF7(2331, 3068, 4540, 5768, 8222, 12640) },
                  { AOM_CDF7(2006, 2006, 3343, 6018, 8693, 23405) },
              },
          },
          {
              {
                  { AOM_CDF7(327, 384, 540, 854, 1554, 3523) },
                  { AOM_CDF7(81, 145, 206, 392, 1120, 4993) },
              },
              {
                  { AOM_CDF7(2414, 3104, 4484, 6553, 7933, 11382) },
                  { AOM_CDF7(2520, 2520, 2520, 2520, 2520, 2520) },
              },
          },
          {
              {
                  { AOM_CDF7(175, 207, 293, 448, 663, 1443) },
                  { AOM_CDF7(55, 80, 131, 252, 623, 2061) },
              },
              {
                  { AOM_CDF7(4327, 4327, 5564, 6800, 8037, 10510) },
                  { AOM_CDF7(4681, 4681, 4681, 4681, 4681, 32768) },
              },
          },
      },
    };
...
static const aom_cdf_prob av1_default_eob_multi128_cdfs
    [TOKEN_CDF_Q_CTXS][EOB_CONTEXTS][PLANE_TYPES][2][CDF_SIZE(8)] = {
      {
          {
              {
                  { AOM_CDF8(2415, 4125, 9185, 14021, 20769, 25773, 30714) },
                  { AOM_CDF8(320, 716, 1520, 8035, 18413, 23811, 28712) },
              },
              {
                  { AOM_CDF8(10993, 14522, 22496, 26902, 30107, 31702, 32609) },
                  { AOM_CDF8(4062, 5687, 8936, 25185, 31143, 32226, 32768) },
              },
          },
          {
              {
                  { AOM_CDF8(448, 825, 2081, 3863, 8723, 16722, 28502) },
                  { AOM_CDF8(163, 434, 836, 3775, 10387, 17403, 25703) },
              },
              {
                  { AOM_CDF8(4019, 4994, 8567, 12140, 17257, 22616, 30737) },
                  { AOM_CDF8(2656, 6199, 7970, 9741, 9741, 15055, 32768) },
              },
          },
          {
              {
                  { AOM_CDF8(186, 396, 746, 1485, 3196, 7451, 22785) },
                  { AOM_CDF8(167, 384, 826, 3303, 7180, 11473, 19834) },
              },
              {
                  { AOM_CDF8(1560, 2184, 2600, 2808, 4265, 7593, 26318) },
                  { AOM_CDF8(537, 537, 537, 537, 537, 1611, 32768) },
              },
          },
          {
              {
                  { AOM_CDF8(57, 142, 363, 714, 1405, 2980, 11943) },
                  { AOM_CDF8(50, 197, 411, 1864, 3960, 5954, 13277) },
              },
              {
                  { AOM_CDF8(869, 869, 869, 869, 2029, 3769, 21168) },
                  { AOM_CDF8(1560, 1560, 1560, 1560, 1560, 1560, 29647) },
              },
          },
          {
              {
                  { AOM_CDF8(59, 96, 234, 357, 686, 1290, 4066) },
                  { AOM_CDF8(19, 165, 350, 1064, 2108, 3391, 7212) },
              },
              {
                  { AOM_CDF8(2397, 2397, 3996, 3996, 3996, 5594, 19980) },
                  { AOM_CDF8(32768, 32768, 32768, 32768, 32768, 32768, 32768) },
              },
          },
          {
              {
                  { AOM_CDF8(15, 25, 76, 127, 205, 329, 941) },
                  { AOM_CDF8(21, 56, 74, 328, 643, 1055, 2115) },
              },
              {
                  { AOM_CDF8(2520, 2520, 2520, 2520, 2520, 2520, 12603) },
                  { AOM_CDF8(32768, 32768, 32768, 32768, 32768, 32768, 32768) },
              },
          },
          {
      ...
      },
      {
          {
              {
                  { AOM_CDF8(3417, 4432, 7139, 12282, 18219, 24092, 29157) },
                  { AOM_CDF8(240, 530, 907, 4571, 11901, 19238, 26616) },
              },
              {
                  { AOM_CDF8(15965, 20360, 26875, 29586, 31351, 32208, 32630) },
                  { AOM_CDF8(8474, 10728, 15012, 26871, 29980, 31489, 32701) },
              },
          },
          {
              {
                  { AOM_CDF8(892, 1075, 1680, 3365, 7089, 16071, 28386) },
                  { AOM_CDF8(177, 328, 462, 1772, 6363, 15070, 25358) },
              },
              {
                  { AOM_CDF8(2165, 3421, 5691, 8221, 13426, 19208, 31512) },
                  { AOM_CDF8(565, 854, 1719, 3717, 4960, 8954, 32479) },
              },
          },
          {
              {
                  { AOM_CDF8(352, 427, 646, 1066, 1957, 5653, 22719) },
                  { AOM_CDF8(108, 194, 273, 797, 2422, 7112, 19384) },
              },
              {
                  { AOM_CDF8(473, 619, 945, 1178, 1835, 3102, 31505) },
                  { AOM_CDF8(2, 30, 46, 155, 248, 2134, 32636) },
              },
          },
          {
              {
                  { AOM_CDF8(157, 184, 278, 429, 740, 1582, 11799) },
                  { AOM_CDF8(66, 105, 147, 381, 1058, 2777, 11211) },
              },
              {
                  { AOM_CDF8(178, 320, 561, 652, 969, 1551, 29831) },
                  { AOM_CDF8(57, 80, 173, 334, 450, 2344, 32467) },
              },
          },
          {
              {
                  { AOM_CDF8(104, 120, 194, 267, 408, 827, 3760) },
                  { AOM_CDF8(37, 52, 99, 294, 648, 1309, 3946) },
              },
              {
                  { AOM_CDF8(2544, 2939, 4044, 4438, 4596, 5109, 24995) },
                  { AOM_CDF8(185, 185, 185, 433, 805, 3159, 32272) },
              },
          },
          {
              {
                  { AOM_CDF8(63, 71, 103, 132, 187, 306, 895) },
                  { AOM_CDF8(23, 34, 55, 111, 198, 375, 968) },
              },
              {
                  { AOM_CDF8(1741, 2691, 3957, 4590, 4907, 5857, 12822) },
                  { AOM_CDF8(1724, 1724, 1724, 5173, 12072, 18970, 32768) },
              },
          },
          {
              {
      ...
      },
      {
          {
              {
                  { AOM_CDF8(4565, 5137, 6832, 12521, 19472, 26080, 30407) },
                  { AOM_CDF8(263, 574, 910, 3559, 11568, 21225, 28891) },
              },
              {
                  { AOM_CDF8(21245, 23892, 27498, 30058, 31779, 32446, 32658) },
                  { AOM_CDF8(11563, 14115, 18540, 27144, 30466, 32293, 32729) },
              },
          },
          {
              {
                  { AOM_CDF8(1475, 1638, 2213, 4597, 9272, 19092, 29839) },
                  { AOM_CDF8(301, 485, 649, 1607, 6590, 16773, 27826) },
              },
              {
                  { AOM_CDF8(2278, 3189, 4451, 6349, 9804, 19607, 31683) },
                  { AOM_CDF8(1057, 1405, 2325, 5061, 6677, 24809, 32618) },
              },
          },
          {
              {
                  { AOM_CDF8(605, 683, 888, 1635, 2982, 7676, 24964) },
                  { AOM_CDF8(187, 304, 434, 926, 3167, 8967, 23027) },
              },
              {
                  { AOM_CDF8(410, 594, 868, 1072, 1382, 6571, 31353) },
                  { AOM_CDF8(229, 308, 587, 926, 1404, 14974, 32688) },
              },
          },
          {
              {
                  { AOM_CDF8(335, 380, 496, 876, 1482, 2940, 14731) },
                  { AOM_CDF8(109, 188, 275, 627, 1844, 4403, 15108) },
              },
              {
                  { AOM_CDF8(969, 1527, 2218, 2988, 3280, 5591, 23948) },
                  { AOM_CDF8(92, 276, 830, 2307, 2861, 12461, 32214) },
              },
          },
          {
              {
                  { AOM_CDF8(234, 269, 370, 547, 860, 1508, 5287) },
                  { AOM_CDF8(48, 81, 135, 375, 1043, 2191, 5579) },
              },
              {
                  { AOM_CDF8(2025, 2422, 3296, 3932, 4329, 5282, 13941) },
                  { AOM_CDF8(5782, 5782, 7067, 9637, 12207, 18632, 31482) },
              },
          },
          {
              {
                  { AOM_CDF8(90, 107, 152, 221, 343, 527, 1388) },
                  { AOM_CDF8(30, 47, 83, 151, 348, 824, 1683) },
              },
              {
                  { AOM_CDF8(866, 1907, 2600, 2947, 3294, 3294, 3987) },
                  { AOM_CDF8(3640, 10922, 10922, 10922, 18204, 25486, 32768) },
              },
          },
          {
              {
      ...
      },
      {
          {
              {
                  { AOM_CDF8(5420, 6883, 10278, 17250, 24647, 29865, 31927) },
                  { AOM_CDF8(790, 1767, 2789, 7285, 16328, 25372, 31000) },
              },
              {
                  { AOM_CDF8(26947, 28686, 30711, 31732, 32302, 32619, 32702) },
                  { AOM_CDF8(12180, 15440, 19958, 29693, 31510, 32441, 32768) },
              },
          },
          {
              {
                  { AOM_CDF8(2152, 2538, 3660, 7171, 13124, 23437, 30862) },
                  { AOM_CDF8(605, 1137, 1768, 3727, 9251, 19748, 29145) },
              },
              {
                  { AOM_CDF8(8287, 10178, 13199, 15326, 18977, 27751, 31375) },
                  { AOM_CDF8(6199, 7970, 9741, 22140, 25683, 29225, 32768) },
              },
          },
          {
              {
                  { AOM_CDF8(1181, 1428, 1953, 3138, 5144, 10810, 26143) },
                  { AOM_CDF8(261, 603, 908, 1870, 4782, 10683, 24274) },
              },
              {
                  { AOM_CDF8(5868, 6906, 9087, 10437, 11372, 18227, 29340) },
                  { AOM_CDF8(14043, 23405, 23405, 32768, 32768, 32768, 32768) },
              },
          },
          {
              {
                  { AOM_CDF8(852, 957, 1235, 1850, 2809, 4762, 16245) },
                  { AOM_CDF8(200, 371, 609, 1375, 3364, 6543, 17076) },
              },
              {
                  { AOM_CDF8(10417, 11175, 13448, 15342, 15721, 17993, 20645) },
                  { AOM_CDF8(10922, 32768, 32768, 32768, 32768, 32768, 32768) },
              },
          },
          {
              {
                  { AOM_CDF8(552, 633, 821, 1184, 1710, 2721, 6940) },
                  { AOM_CDF8(112, 254, 393, 937, 2055, 4222, 10200) },
              },
              {
                  { AOM_CDF8(4937, 7630, 10324, 11221, 11221, 13915, 17506) },
                  { AOM_CDF8(32768, 32768, 32768, 32768, 32768, 32768, 32768) },
              },
          },
          {
              {
                  { AOM_CDF8(279, 311, 386, 543, 850, 1439, 3195) },
                  { AOM_CDF8(94, 181, 289, 685, 1222, 2609, 5953) },
              },
              {
                  { AOM_CDF8(9637, 9637, 9637, 9637, 9637, 9637, 9637) },
                  { AOM_CDF8(32768, 32768, 32768, 32768, 32768, 32768, 32768) },
              },
          },
          {
...
static const aom_cdf_prob av1_default_eob_multi256_cdfs
    [TOKEN_CDF_Q_CTXS][EOB_CONTEXTS][PLANE_TYPES][2][CDF_SIZE(9)] = {
      {
          {
              {
                  { AOM_CDF9(2055, 2957, 8403, 12281, 19390, 24742, 29064,
                             31640) },
                  { AOM_CDF9(480, 1826, 2648, 5183, 21929, 25181, 29097,
                             31317) },
              },
              {
                  { AOM_CDF9(6263, 7993, 14337, 19070, 26559, 30206, 31495,
                             32199) },
                  { AOM_CDF9(3830, 4681, 8085, 13192, 26810, 30214, 31065,
                             32768) },
              },
          },
          {
              {
                  { AOM_CDF9(285, 368, 925, 1633, 3490, 6307, 14018, 26889) },
                  { AOM_CDF9(404, 1308, 2451, 3593, 14777, 18156, 22963,
                             27723) },
              },
              {
                  { AOM_CDF9(1326, 1487, 2211, 3176, 4864, 7438, 9126, 17811) },
                  { AOM_CDF9(1724, 1724, 1724, 1724, 1724, 1724, 5173, 32768) },
              },
          },
          {
              {
                  { AOM_CDF9(290, 343, 671, 971, 1557, 2391, 3769, 9555) },
                  { AOM_CDF9(391, 652, 1087, 2567, 8746, 11009, 13446, 16927) },
              },
              {
                  { AOM_CDF9(80, 80, 560, 721, 881, 881, 1041, 5047) },
                  { AOM_CDF9(885, 885, 885, 885, 885, 885, 885, 32768) },
              },
          },
          {
              {
                  { AOM_CDF9(9, 15, 77, 145, 219, 331, 529, 1260) },
                  { AOM_CDF9(161, 377, 485, 701, 1673, 1997, 3292, 4912) },
              },
              {
                  { AOM_CDF9(239, 239, 239, 239, 239, 239, 239, 717) },
                  { AOM_CDF9(6553, 6553, 6553, 6553, 6553, 6553, 6553, 19660) },
              },
          },
          {
              {
                  { AOM_CDF9(95, 95, 116, 201, 329, 413, 626, 881) },
                  { AOM_CDF9(191, 191, 574, 958, 1341, 1341, 1341, 1724) },
              },
              {
                  { AOM_CDF9(1724, 1724, 1724, 1724, 1724, 1724, 1724, 5173) },
                  { AOM_CDF9(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                             32768) },
              },
          },
          {
      ...
      },
      {
          {
              {
                  { AOM_CDF9(4141, 5250, 10003, 13911, 18418, 23695, 28267,
                             30232) },
                  { AOM_CDF9(455, 1650, 2391, 3926, 16024, 21766, 28006,
                             30696) },
              },
              {
                  { AOM_CDF9(11537, 14658, 22700, 26199, 29180, 30601, 31704,
                             32366) },
                  { AOM_CDF9(4634, 6384, 9396, 13773, 26904, 30810, 31827,
                             32714) },
              },
          },
          {
              {
                  { AOM_CDF9(658, 813, 1463, 2107, 3190, 5997, 13362, 23824) },
                  { AOM_CDF9(171, 624, 1054, 1682, 7041, 10813, 19814, 26417) },
              },
              {
                  { AOM_CDF9(268, 350, 753, 1022, 1421, 1996, 3840, 21702) },
                  { AOM_CDF9(116, 168, 349, 504, 1255, 1618, 2162, 32690) },
              },
          },
          {
              {
                  { AOM_CDF9(253, 287, 603, 829, 1202, 1749, 2948, 8143) },
                  { AOM_CDF9(73, 293, 536, 881, 3634, 5208, 8956, 12968) },
              },
              {
                  { AOM_CDF9(145, 156, 283, 438, 487, 538, 648, 14089) },
                  { AOM_CDF9(18, 18, 18, 91, 237, 383, 492, 32585) },
              },
          },
          {
              {
                  { AOM_CDF9(90, 122, 225, 306, 439, 639, 944, 1592) },
                  { AOM_CDF9(30, 99, 175, 312, 1306, 1857, 3609, 4792) },
              },
              {
                  { AOM_CDF9(106, 106, 259, 290, 320, 473, 595, 6431) },
                  { AOM_CDF9(222, 222, 222, 222, 668, 668, 668, 32768) },
              },
          },
          {
              {
                  { AOM_CDF9(93, 116, 234, 341, 542, 732, 1087, 1532) },
                  { AOM_CDF9(21, 82, 153, 242, 840, 1268, 2135, 2723) },
              },
              {
                  { AOM_CDF9(2184, 2184, 5097, 8009, 12379, 13835, 13835,
                             13835) },
                  { AOM_CDF9(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                             32768) },
              },
      ...
      },
      {
          {
              {
                  { AOM_CDF9(6065, 6977, 10257, 14570, 19468, 24787, 28880,
                             30565) },
                  { AOM_CDF9(993, 2558, 3741, 5600, 14879, 21909, 28984,
                             31601) },
              },
              {
                  { AOM_CDF9(17136, 19602, 25296, 27767, 29876, 31292, 31957,
                             32484) },
                  { AOM_CDF9(10620, 13083, 16463, 21374, 28869, 31281, 32396,
                             32733) },
              },
          },
          {
              {
                  { AOM_CDF9(1209, 1391, 1985, 2766, 4174, 6946, 14118,
                             25951) },
                  { AOM_CDF9(452, 1172, 1890, 2841, 7272, 12992, 21473,
                             28993) },
              },
              {
                  { AOM_CDF9(166, 224, 385, 506, 667, 877, 1231, 29922) },
                  { AOM_CDF9(506, 691, 1428, 2903, 6682, 7696, 11383, 32399) },
              },
          },
          {
              {
                  { AOM_CDF9(462, 542, 809, 1104, 1589, 2220, 3535, 10682) },
                  { AOM_CDF9(250, 686, 1180, 1974, 5542, 8085, 12515, 19123) },
              },
              {
                  { AOM_CDF9(56, 86, 282, 388, 553, 606, 666, 20990) },
                  { AOM_CDF9(242, 242, 242, 728, 3155, 3155, 5097, 32768) },
              },
          },
          {
              {
                  { AOM_CDF9(230, 276, 391, 499, 684, 954, 1390, 2261) },
                  { AOM_CDF9(115, 354, 606, 890, 2515, 3492, 5058, 6592) },
              },
              {
                  { AOM_CDF9(153, 153, 153, 357, 460, 869, 1175, 4856) },
                  { AOM_CDF9(4681, 4681, 4681, 4681, 14043, 14043, 14043,
                             23405) },
              },
          },
          {
              {
                  { AOM_CDF9(253, 328, 494, 704, 971, 1387, 2112, 2922) },
                  { AOM_CDF9(178, 416, 582, 844, 2057, 3175, 4412, 5411) },
              },
              {
                  { AOM_CDF9(4681, 4681, 4681, 4681, 4681, 4681, 4681, 4681) },
                  { AOM_CDF9(10922, 10922, 10922, 10922, 10922, 10922, 10922,
                             10922) },
              },
          },
          {
      ...
      },
      {
          {
              {
                  { AOM_CDF9(7897, 9630, 13958, 18886, 24070, 28475, 31372,
                             32064) },
                  { AOM_CDF9(3906, 5874, 7653, 9985, 18077, 24820, 30659,
                             32270) },
              },
              {
                  { AOM_CDF9(25450, 26854, 30008, 31058, 31692, 32064, 32245,
                             32634) },
                  { AOM_CDF9(12087, 14942, 19544, 24321, 30845, 32185, 32593,
                             32768) },
              },
          },
          {
              {
                  { AOM_CDF9(1930, 2261, 3410, 4634, 6668, 9953, 19033,
                             27975) },
                  { AOM_CDF9(1119, 2216, 3349, 4739, 9799, 15239, 23641,
                             29828) },
              },
              {
                  { AOM_CDF9(961, 1289, 1709, 2055, 2320, 2602, 4079, 29276) },
                  { AOM_CDF9(5782, 5782, 5782, 5782, 21202, 32768, 32768,
                             32768) },
              },
          },
          {
              {
                  { AOM_CDF9(1154, 1359, 1901, 2434, 3115, 4092, 5960, 12107) },
                  { AOM_CDF9(709, 1494, 2154, 2832, 7169, 10845, 15672,
                             21828) },
              },
              {
                  { AOM_CDF9(3507, 4705, 6758, 7101, 7785, 8641, 8812, 12405) },
                  { AOM_CDF9(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                             32768) },
              },
          },
          {
              {
                  { AOM_CDF9(563, 654, 921, 1213, 1658, 2207, 3146, 5407) },
                  { AOM_CDF9(278, 663, 920, 1605, 4216, 6399, 8967, 12092) },
              },
              {
                  { AOM_CDF9(618, 618, 618, 1854, 1854, 1854, 1854, 6800) },
                  { AOM_CDF9(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                             32768) },
              },
          },
          {
              {
                  { AOM_CDF9(752, 863, 1307, 1703, 2448, 3811, 5253, 7900) },
                  { AOM_CDF9(312, 936, 2184, 2184, 5305, 7177, 9674, 12795) },
              },
              {
                  { AOM_CDF9(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                             32768) },
...
static const aom_cdf_prob av1_default_eob_multi512_cdfs
    [TOKEN_CDF_Q_CTXS][EOB_CONTEXTS][PLANE_TYPES][2][CDF_SIZE(10)] = {
      {
          {
              {
                  { AOM_CDF10(2196, 2944, 6170, 9762, 17856, 23798, 28155,
                              31728, 32385) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
              {
                  { AOM_CDF10(3581, 6500, 11276, 16848, 24012, 29584, 31972,
                              32768, 32768) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
          ...
          {
              {
                  { AOM_CDF10(337, 563, 1689, 3265, 7544, 11147, 14300, 23309,
                              28038) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
          ...
          {
              {
                  { AOM_CDF10(1424, 1424, 2374, 4274, 10922, 10922, 10922,
                              10922, 11872) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
          ...
          {
              {
                  { AOM_CDF10(992, 992, 992, 992, 4964, 4964, 4964, 4964,
                              4964) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
      ...
      },
      {
          {
              {
                  { AOM_CDF10(2618, 3993, 7706, 12987, 19105, 23159, 26564,
                              29413, 31126) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
              {
                  { AOM_CDF10(13290, 17348, 26937, 30320, 31586, 32131, 32376,
                              32576, 32760) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
          ...
          {
              {
                  { AOM_CDF10(413, 891, 1801, 3121, 5194, 6796, 9357, 14489,
                              24886) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
              {
                  { AOM_CDF10(12, 12, 12, 12, 37, 37, 37, 458, 27366) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
          },
          {
              {
                  { AOM_CDF10(445, 736, 1527, 2378, 3851, 4722, 6044, 8158,
                              13016) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
              {
                  { AOM_CDF10(85, 85, 85, 85, 85, 85, 85, 256, 20619) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
          },
          {
              {
                  { AOM_CDF10(315, 676, 1216, 2028, 3290, 3921, 4912, 5543,
                              6625) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
      ...
      },
      {
          {
              {
                  { AOM_CDF10(4212, 6013, 9629, 13976, 18425, 22048, 26026,
                              29741, 31670) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
              {
                  { AOM_CDF10(19784, 22918, 28897, 30405, 30993, 31314, 31567,
                              32228, 32756) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
          ...
          {
              {
                  { AOM_CDF10(985, 1404, 2391, 3223, 4438, 5567, 7756, 15582,
                              26942) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
              {
                  { AOM_CDF10(4, 4, 7, 7, 10, 10, 19, 4657, 32312) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
          },
          {
              {
                  { AOM_CDF10(708, 1077, 1699, 2339, 3278, 4139, 5123, 8424,
                              14230) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
              {
                  { AOM_CDF10(97, 97, 97, 97, 97, 97, 97, 880, 24747) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
          },
          {
              {
                  { AOM_CDF10(450, 1094, 1866, 3669, 4184, 5214, 6502, 8304,
                              11008) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
      ...
      },
      {
          {
              {
                  { AOM_CDF10(10073, 11918, 15607, 19716, 23790, 26993, 29961,
                              31927, 32481) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
              {
                  { AOM_CDF10(24792, 26654, 28647, 29591, 29994, 30182, 30294,
                              32600, 32733) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
          ...
          {
              {
                  { AOM_CDF10(1980, 2530, 3698, 4776, 5762, 6895, 8924, 17593,
                              29192) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
              {
                  { AOM_CDF10(27, 60, 82, 82, 82, 82, 92, 15096, 32549) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
          },
          {
              {
                  { AOM_CDF10(1609, 2227, 3643, 4570, 5935, 6939, 8201, 11085,
                              18089) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
              {
                  { AOM_CDF10(618, 618, 618, 618, 618, 618, 3091, 8037,
                              12983) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
          ...
          {
              {
                  { AOM_CDF10(728, 1213, 2184, 4126, 6068, 7039, 8495, 9466,
                              12864) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
              {
                  { AOM_CDF10(3640, 3640, 3640, 3640, 3640, 3640, 3640, 3640,
                              3640) },
                  { AOM_CDF10(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768) },
              },
...
static const aom_cdf_prob av1_default_eob_multi1024_cdfs
    [TOKEN_CDF_Q_CTXS][EOB_CONTEXTS][PLANE_TYPES][2][CDF_SIZE(11)] = {
      {
          {
              {
                  { AOM_CDF11(1005, 1066, 2125, 3395, 7721, 14512, 24131, 28517,
                              30559, 31921) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
              {
                  { AOM_CDF11(2377, 2790, 12094, 14781, 20156, 22844, 26359,
                              29873, 30080, 30700) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
          ...
          {
              {
                  { AOM_CDF11(885, 885, 885, 2302, 3365, 5136, 6199, 9033,
                              10450, 12221) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
              {
                  { AOM_CDF11(537, 537, 537, 537, 537, 537, 537, 537, 537,
                              8057) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
          ...
          {
              {
                  { AOM_CDF11(555, 555, 555, 555, 555, 555, 555, 555, 555,
                              555) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
              {
                  { AOM_CDF11(10922, 10922, 10922, 10922, 10922, 10922, 10922,
                              10922, 10922, 10922) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
      ...
      },
      {
          {
              {
                  { AOM_CDF11(1755, 2283, 5254, 8887, 15143, 20856, 25158,
                              27618, 29684, 31063) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
              {
                  { AOM_CDF11(3625, 4728, 8339, 10830, 12532, 13156, 13524,
                              13676, 13730, 27041) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
          ...
          {
              {
                  { AOM_CDF11(158, 183, 494, 916, 1799, 2744, 3888, 5112, 6921,
                              11533) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
              {
                  { AOM_CDF11(2, 2, 2, 2, 6, 6, 6, 6, 6, 12284) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
          },
          {
              {
                  { AOM_CDF11(171, 171, 239, 376, 719, 924, 1335, 1677, 2088,
                              2499) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
              {
                  { AOM_CDF11(728, 728, 728, 728, 728, 728, 728, 728, 728,
                              728) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
      ...
      },
      {
          {
              {
                  { AOM_CDF11(3904, 5648, 10698, 14743, 19973, 23930, 26799,
                              28528, 30063, 31433) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
              {
                  { AOM_CDF11(7773, 10177, 14025, 16189, 17137, 17464, 17682,
                              17807, 17846, 32437) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
          ...
          {
              {
                  { AOM_CDF11(392, 498, 905, 1262, 1741, 2278, 2876, 3495, 4560,
                              14214) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
              {
                  { AOM_CDF11(8, 8, 10, 10, 11, 11, 11, 13, 19, 30143) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
          },
          {
              {
                  { AOM_CDF11(265, 265, 371, 690, 1221, 1433, 1965, 2071, 2177,
                              2496) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
              {
                  { AOM_CDF11(425, 425, 425, 425, 425, 425, 425, 425, 425,
                              425) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
      ...
      },
      {
          {
              {
                  { AOM_CDF11(11424, 13560, 18293, 22444, 26395, 28982, 30505,
                              31296, 31974, 32437) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
              {
                  { AOM_CDF11(17398, 19239, 22182, 23360, 23929, 24107, 24203,
                              24243, 24255, 32736) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
          ...
          {
              {
                  { AOM_CDF11(924, 1101, 1760, 2313, 3220, 3921, 4510, 4899,
                              6026, 14260) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
              {
                  { AOM_CDF11(25, 25, 25, 32, 39, 39, 39, 39, 68, 32451) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
          },
          {
              {
                  { AOM_CDF11(131, 131, 131, 657, 1710, 3553, 4605, 6185, 6711,
                              6974) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
              {
                  { AOM_CDF11(618, 618, 618, 618, 1854, 1854, 1854, 1854, 1854,
                              3091) },
                  { AOM_CDF11(32768, 32768, 32768, 32768, 32768, 32768, 32768,
                              32768, 32768, 32768) },
              },
