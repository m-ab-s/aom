  ...
  switch (sf->inter_sf.selective_ref_frame) {
    ...
    case 1:
      if (comp_pred) {
        ...
        if (dir_refrank[0][d0] > INTER_REFS_PER_FRAME_NRS - 2) return 1;
      }
      break;
    case 2:
      if (comp_pred) {
        ...
        if (dir_refrank[0][d0] > INTER_REFS_PER_FRAME_NRS - 3) return 1;
      }
      break;
    case 3:
    default:
      if (comp_pred) {
        ...
        if (dir_refrank[0][d0] > INTER_REFS_PER_FRAME_NRS - 4) return 1;
      }
      break;
  }
  return 0;
