...
static void tf_motion_search(AV1_COMP *cpi,
  ...
  const MvSubpelPrecision max_mv_precision = MV_SUBPEL_EIGHTH_PRECISION;
  assert(cm->features.fr_mv_precision == MV_SUBPEL_EIGHTH_PRECISION);
