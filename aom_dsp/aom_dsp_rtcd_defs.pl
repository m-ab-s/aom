...
if (aom_config("CONFIG_3WAY_PARTITIONS") eq "") {
  ...
  specialize qw/aom_sub_pixel_avg_variance64x64    avx2/;
  specialize qw/aom_sub_pixel_avg_variance64x32    avx2/;
  specialize qw/aom_sub_pixel_avg_variance32x64    avx2/;
  specialize qw/aom_sub_pixel_avg_variance32x32    avx2/;
...
if (aom_config("CONFIG_3WAY_PARTITIONS") eq "") {
    ...
    specialize qw/aom_sub_pixel_avg_variance64x128           sse2 ssse3/;
    specialize qw/aom_sub_pixel_avg_variance64x64        msa sse2 ssse3/;
