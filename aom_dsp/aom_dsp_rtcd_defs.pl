...
if (aom_config("CONFIG_FLEX_PARTITION") eq "yes") {
  specialize qw/aom_dc_predictor_4x32 sse2/;
  specialize qw/aom_dc_predictor_32x4 sse2/;
  specialize qw/aom_dc_predictor_8x64 sse2/;
  specialize qw/aom_dc_predictor_64x8 sse2/;
  specialize qw/aom_dc_predictor_4x64 sse2/;
  specialize qw/aom_dc_predictor_64x4 sse2/;

  specialize qw/aom_dc_top_predictor_4x32 sse2/;
  specialize qw/aom_dc_top_predictor_32x4 sse2/;
  specialize qw/aom_dc_top_predictor_8x64 sse2/;
  specialize qw/aom_dc_top_predictor_64x8 sse2/;
  specialize qw/aom_dc_top_predictor_4x64 sse2/;
  specialize qw/aom_dc_top_predictor_64x4 sse2/;

  specialize qw/aom_dc_left_predictor_4x32 sse2/;
  specialize qw/aom_dc_left_predictor_32x4 sse2/;
  specialize qw/aom_dc_left_predictor_8x64 sse2/;
  specialize qw/aom_dc_left_predictor_64x8 sse2/;
  specialize qw/aom_dc_left_predictor_4x64 sse2/;
  specialize qw/aom_dc_left_predictor_64x4 sse2/;

  specialize qw/aom_dc_128_predictor_4x32 sse2/;
  specialize qw/aom_dc_128_predictor_32x4 sse2/;
  specialize qw/aom_dc_128_predictor_8x64 sse2/;
  specialize qw/aom_dc_128_predictor_64x8 sse2/;
  specialize qw/aom_dc_128_predictor_4x64 sse2/;
  specialize qw/aom_dc_128_predictor_64x4 sse2/;

  specialize qw/aom_v_predictor_4x32 sse2/;
  specialize qw/aom_v_predictor_32x4 sse2/;
  specialize qw/aom_v_predictor_8x64 sse2/;
  specialize qw/aom_v_predictor_64x8 sse2/;
  specialize qw/aom_v_predictor_4x64 sse2/;
  specialize qw/aom_v_predictor_64x4 sse2/;

  specialize qw/aom_h_predictor_4x32 sse2/;
  specialize qw/aom_h_predictor_32x4 sse2/;
  specialize qw/aom_h_predictor_8x64 sse2/;
  specialize qw/aom_h_predictor_64x8 sse2/;
  specialize qw/aom_h_predictor_4x64 sse2/;
  specialize qw/aom_h_predictor_64x4 sse2/;
}
...
if (aom_config("CONFIG_EXT_PARTITIONS") eq "") {
  specialize qw/aom_highbd_dc_predictor_8x8 neon/;
} # CONFIG_EXT_PARTITIONS
...
if (aom_config("CONFIG_EXT_PARTITIONS") eq "") {
  specialize qw/aom_highbd_dc_predictor_16x16 neon/;
} # CONFIG_EXT_PARTITIONS
...
specialize qw/aom_convolve_copy       sse2 avx2/;
if (aom_config("CONFIG_EXT_PARTITIONS") eq "") {
  specialize qw/aom_convolve_copy neon/;
} # CONFIG_EXT_PARTITIONS
...
if (aom_config("CONFIG_AV1_ENCODER") eq "yes") {
  ...
  specialize qw/aom_sad32x8      avx2 sse2/;
  specialize qw/aom_sad16x64          sse2/;
  specialize qw/aom_sad64x16     avx2 sse2/;

  specialize qw/aom_sad4x16_avg       sse2/;
  specialize qw/aom_sad16x4_avg       sse2/;
  specialize qw/aom_sad8x32_avg       sse2/;
  specialize qw/aom_sad32x8_avg  avx2 sse2/;
  specialize qw/aom_sad16x64_avg      sse2/;
  specialize qw/aom_sad64x16_avg avx2 sse2/;

  if (aom_config("CONFIG_FLEX_PARTITION") eq "yes") {
    specialize qw/aom_sad4x32           sse2/;
    specialize qw/aom_sad32x4      avx2 sse2/;
    specialize qw/aom_sad8x64           sse2/;
    specialize qw/aom_sad64x8      avx2 sse2/;
    specialize qw/aom_sad4x64           sse2/;
    specialize qw/aom_sad64x4      avx2 sse2/;
    specialize qw/aom_sad4x32_avg       sse2/;
    specialize qw/aom_sad32x4_avg  avx2 sse2/;
    specialize qw/aom_sad8x64_avg       sse2/;
    specialize qw/aom_sad64x8_avg  avx2 sse2/;
    specialize qw/aom_sad4x64_avg       sse2/;
    specialize qw/aom_sad64x4_avg  avx2 sse2/;
  }
  ...
  foreach (@block_sizes) {
    ...
    if ($w != 128 && $h != 128 && $w != 4 &&
     ((aom_config("CONFIG_EXT_PARTITIONS") eq "") || (!($w == 16 && $h == 32)))) {
     # 8x16 and 16x32 functions have an alignment issue with CONFIG_EXT_PARTITIONS experiment. So disabled for now.
  ...
  if (aom_config("CONFIG_FLEX_PARTITION") eq "yes") {
    ...
    specialize qw/aom_highbd_sad32x4_avg   avx2 sse2/;
    specialize qw/aom_highbd_sad8x64_avg   sse2/;
    specialize qw/aom_highbd_sad64x8_avg   avx2 sse2/;
  ...
  specialize qw/aom_sad16x32x4d                 sse2/;
  if (aom_config("CONFIG_EXT_PARTITIONS") eq "") {
    specialize qw/aom_sad16x32x4d                msa/;
  } # CONFIG_EXT_PARTITIONS
...
if (aom_config("CONFIG_AV1_ENCODER") eq "yes") {
  ...
  specialize qw/aom_sub_pixel_variance128x128  sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_variance128x64   sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_variance64x128   sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_variance64x64    sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_variance64x32    sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_variance32x64    sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_variance32x32    sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_variance32x16    sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_variance16x32    sse2 ssse3/;
  specialize qw/aom_sub_pixel_variance16x16    sse2 ssse3/;
  specialize qw/aom_sub_pixel_variance16x8     sse2 ssse3/;

if (aom_config("CONFIG_EXT_PARTITIONS") eq "") {
    specialize qw/aom_sub_pixel_variance64x64          neon msa/;
    specialize qw/aom_sub_pixel_variance64x32               msa/;
    specialize qw/aom_sub_pixel_variance32x64               msa/;
    specialize qw/aom_sub_pixel_variance32x32          neon msa/;
    specialize qw/aom_sub_pixel_variance32x16               msa/;
    specialize qw/aom_sub_pixel_variance16x32               msa/;
    specialize qw/aom_sub_pixel_variance16x16          neon msa/;
    specialize qw/aom_sub_pixel_variance16x8                msa/;
} # CONFIG_EXT_PARTITIONS
  ...
  specialize qw/aom_sub_pixel_avg_variance128x128 sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_avg_variance128x64  sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_avg_variance64x128  sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_avg_variance64x64   sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_avg_variance64x32   sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_avg_variance32x64   sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_avg_variance32x32   sse2 ssse3 avx2/;
  specialize qw/aom_sub_pixel_avg_variance32x16   sse2 ssse3 avx2/;
...
if (aom_config("CONFIG_EXT_PARTITIONS") eq "") {
    specialize qw/aom_sub_pixel_avg_variance64x64        msa/;
    specialize qw/aom_sub_pixel_avg_variance64x32        msa/;
    specialize qw/aom_sub_pixel_avg_variance32x64        msa/;
    specialize qw/aom_sub_pixel_avg_variance32x32        msa/;
    specialize qw/aom_sub_pixel_avg_variance32x16        msa/;
    specialize qw/aom_sub_pixel_avg_variance16x32        msa/;
    specialize qw/aom_sub_pixel_avg_variance16x16        msa/;
    specialize qw/aom_sub_pixel_avg_variance16x8         msa/;
} # CONFIG_EXT_PARTITIONS
  ...
  if (aom_config("CONFIG_FLEX_PARTITION") eq "yes") {
    ...
    specialize qw/aom_variance32x4 sse2 avx2/;
    specialize qw/aom_variance4x32 sse2/;
    specialize qw/aom_variance4x64 sse2/;
    specialize qw/aom_variance8x64 sse2/;
    specialize qw/aom_variance64x8 sse2/;
  ...
  specialize qw/aom_sub_pixel_variance64x16 sse2 ssse3 avx2/;
  ...
  if (aom_config("CONFIG_FLEX_PARTITION") eq "yes") {
    ...
    specialize qw/aom_sub_pixel_variance64x8 sse2 ssse3 avx2/;
    specialize qw/aom_sub_pixel_variance4x64 sse2 ssse3/;
    specialize qw/aom_sub_pixel_variance64x4 sse2 ssse3 avx2/;
    specialize qw/aom_sub_pixel_variance4x32 sse2 ssse3/;
    specialize qw/aom_sub_pixel_variance32x4 sse2 ssse3 avx2/;
    specialize qw/aom_sub_pixel_avg_variance8x64 sse2 ssse3/;
    specialize qw/aom_sub_pixel_avg_variance64x8 sse2 ssse3 avx2/;
    specialize qw/aom_sub_pixel_avg_variance4x64 sse2 ssse3/;
    specialize qw/aom_sub_pixel_avg_variance64x4 sse2 ssse3 avx2/;
    specialize qw/aom_sub_pixel_avg_variance4x32 sse2 ssse3/;
  ...
  if (aom_config("CONFIG_FLEX_PARTITION") eq "yes") {
    specialize qw/aom_dist_wtd_sub_pixel_avg_variance8x64 ssse3/;
    specialize qw/aom_dist_wtd_sub_pixel_avg_variance64x8 ssse3/;
    specialize qw/aom_dist_wtd_sub_pixel_avg_variance4x64 ssse3/;
    specialize qw/aom_dist_wtd_sub_pixel_avg_variance64x4 ssse3/;
    specialize qw/aom_dist_wtd_sub_pixel_avg_variance4x32 ssse3/;
    specialize qw/aom_dist_wtd_sub_pixel_avg_variance32x4 ssse3/;
  }
  ...
  foreach $bd (8, 10, 12) {
    ...
    foreach (@block_sizes) {
      ...
      if ($w != 128 && $h != 128 && $w != 4 &&
          ((aom_config("CONFIG_EXT_PARTITIONS") eq "") || (!($w == 8 && $h == 16) && !($w == 16 && $h == 32)))) {
        # 8x16 and 16x32 functions have an alignment issue with CONFIG_EXT_PARTITIONS experiment. So disabled for now.
  ...
  specialize qw/aom_dist_wtd_comp_avg_pred ssse3/;
    ...
    add_proto qw/unsigned int aom_highbd_10_variance64x16/, "const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse";
    specialize qw/aom_highbd_10_variance64x16 sse2 avx2/;

    add_proto qw/unsigned int aom_highbd_10_variance16x64/, "const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse";
    specialize qw/aom_highbd_10_variance16x64 sse2 avx2/;

    add_proto qw/unsigned int aom_highbd_10_variance32x8/, "const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse";
    specialize qw/aom_highbd_10_variance32x8 sse2 avx2/;

    add_proto qw/unsigned int aom_highbd_10_variance8x32/, "const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse";
    specialize qw/aom_highbd_10_variance8x32 sse2 avx2/;

    if (aom_config("CONFIG_FLEX_PARTITION") eq "yes") {
      add_proto qw/unsigned int aom_highbd_10_variance64x8/, "const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse";
      specialize qw/aom_highbd_10_variance64x8 sse2 avx2/;

      add_proto qw/unsigned int aom_highbd_10_variance8x64/, "const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse";
