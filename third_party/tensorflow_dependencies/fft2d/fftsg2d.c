...
void cdft2d(int n1, int n2, int isgn, double **a, double *t, int *ip,
            double *w) {
...
void rdft2d(int n1, int n2, int isgn, double **a, double *t, int *ip,
            double *w) {
  void makewt(int nw, int *ip, double *w);
...
void ddct2d(int n1, int n2, int isgn, double **a, double *t, int *ip,
            double *w) {
  void makewt(int nw, int *ip, double *w);
  void makect(int nc, int *ip, double *c);
  void ddct(int n, int isgn, double *a, int *ip, double *w);
  void ddxt2d_sub(int n1, int n2, int ics, int isgn, double **a, double *t,
                  int *ip, double *w);
#ifdef USE_FFT2D_THREADS
...
void ddst2d(int n1, int n2, int isgn, double **a, double *t, int *ip,
            double *w) {
  void makewt(int nw, int *ip, double *w);
  void makect(int nc, int *ip, double *c);
