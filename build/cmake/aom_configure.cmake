...
if(CONFIG_CNN_RESTORATION AND CMAKE_TOOLCHAIN_FILE)
  change_config_and_warn(CONFIG_CNN_RESTORATION 0 "CMAKE_TOOLCHAIN_FILE")
endif()

if(CONFIG_LOOP_RESTORE_CNN AND CMAKE_TOOLCHAIN_FILE)
  change_config_and_warn(CONFIG_LOOP_RESTORE_CNN 0 "CMAKE_TOOLCHAIN_FILE")
endif()

if(CONFIG_CNN_RESTORATION_SMALL_MODELS AND CMAKE_TOOLCHAIN_FILE)
  change_config_and_warn(CONFIG_CNN_RESTORATION_SMALL_MODELS 0
