  ...
  virtual void PreEncodeFrameHook(::libaom_test::VideoSource *video,
    ...
    if (video->frame() == 0 && layer_frame_cnt_ == 0) {
      ...
      if (set_speed_per_layer_) {
        // This is for (3SL, 3TL)
        // SLO
        svc_params_.speed_per_layer[0] = 6;
        svc_params_.speed_per_layer[1] = 7;
        svc_params_.speed_per_layer[2] = 8;
        // SL1
        svc_params_.speed_per_layer[3] = 7;
        svc_params_.speed_per_layer[4] = 8;
        svc_params_.speed_per_layer[5] = 9;
        // SL2
        svc_params_.speed_per_layer[6] = 8;
